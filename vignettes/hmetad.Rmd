...
## Introduction
This vignette demonstrates how to use the `hmetad` package to fit the meta-d' model [@maniscalco2012] to a dataset including a binary decision with confidence ratings.
