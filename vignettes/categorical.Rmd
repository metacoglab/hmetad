...
#>  1           1     1     1        0        0       1          3   1.65 -0.523        1.13  0.686
#>  2           1     1     1        1        1       1          3   1.65 -0.523        1.13  0.686
#>  3           1     2     1        0        0       1          3   1.65  0.532        1.08  0.653
#>  4           1     2     1        1        0       0          3   1.65  0.532        1.08  0.653
#>  5           1     3     1        0        1       0          3   2.52 -0.400        2.03  0.805
#>  6           1     3     1        1        1       1          1   2.52 -0.400        2.03  0.805
#>  7           1     4     1        0        0       1          2   1.35 -0.0776       0.962 0.712
#>  8           1     4     1        1        1       1          3   1.35 -0.0776       0.962 0.712
#>  9           1     5     1        0        0       1          3   1.49  1.42         1.00  0.674
#> 10           1     5     1        1        0       0          3   1.49  1.42         1.00  0.674
#> # ℹ 2,490 more rows
#> # ℹ 5 more variables: meta_c2_0 <list>, meta_c2_1 <list>, theta <dbl>, theta_1 <dbl>,
#> #   theta_2 <dbl>
```
...
#>  4           1     4     1     1           0          1          0          0          0          0
#>  5           1     5     1     1           1          0          0          0          0          0
#>  6           1     6     1     1           1          0          0          0          0          0
#>  7           1     7     1     1           1          0          0          0          0          0
#>  8           1     8     1     1           0          1          0          0          0          0
#>  9           1     9     1     1           0          0          1          0          0          0
#> 10           1    10     1     1           0          1          0          0          0          0
#> # ℹ 1,240 more rows
...
#> sd(Intercept)                     0.11      0.08     0.00     0.31 1.00     1742     1875
#> sd(dprime_Intercept)              0.64      0.16     0.39     1.02 1.00      842     1570
#> sd(c_Intercept)                   0.74      0.11     0.55     1.00 1.01      653     1281
#> sd(metac2zero1diff_Intercept)     0.18      0.11     0.01     0.42 1.00      766     1250
#> sd(metac2zero2diff_Intercept)     0.10      0.07     0.00     0.28 1.00     1333     1836
#> sd(metac2one1diff_Intercept)      0.08      0.07     0.00     0.24 1.00     1539     1976
#> sd(metac2one2diff_Intercept)      0.07      0.06     0.00     0.22 1.00     2297     2357
#> 
#> ~participant (Number of levels: 50) 
#>                               Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
#> sd(Intercept)                     0.10      0.08     0.00     0.28 1.00     1582     1576
#> sd(dprime_Intercept)              0.36      0.08     0.20     0.53 1.00     1818     2087
#> sd(c_Intercept)                   0.36      0.05     0.28     0.46 1.00     1476     2582
#> sd(metac2zero1diff_Intercept)     0.31      0.11     0.04     0.52 1.02      233       87
#> sd(metac2zero2diff_Intercept)     0.22      0.11     0.02     0.43 1.00      750      987
#> sd(metac2one1diff_Intercept)      0.12      0.08     0.01     0.30 1.00     1040     1726
#> sd(metac2one2diff_Intercept)      0.37      0.10     0.17     0.59 1.00      992     1261
#> 
#> Regression Coefficients:
#>                           Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
#> Intercept                    -0.26      0.09    -0.43    -0.10 1.00     4541     2909
#> dprime_Intercept              1.16      0.17     0.77     1.45 1.00      917     1425
#> c_Intercept                   0.11      0.13    -0.17     0.37 1.00      566      979
#> metac2zero1diff_Intercept    -0.85      0.07    -0.98    -0.70 1.00     2116     2507
#> metac2zero2diff_Intercept    -0.85      0.06    -0.97    -0.73 1.00     2989     2973
#> metac2one1diff_Intercept     -0.83      0.05    -0.94    -0.72 1.00     4931     3004
#> metac2one2diff_Intercept     -0.84      0.07    -0.96    -0.70 1.00     2909     2948
#> 
...
#>  1           1     1     1        0              1        0       1          3   1.65 -0.523 
#>  2           1     1     1        1              6        1       1          3   1.65 -0.523 
#>  3           1     2     1        0              1        0       1          3   1.65  0.532 
#>  4           1     2     1        1              1        0       0          3   1.65  0.532 
#>  5           1     3     1        0              6        1       0          3   2.52 -0.400 
#>  6           1     3     1        1              4        1       1          1   2.52 -0.400 
#>  7           1     4     1        0              2        0       1          2   1.35 -0.0776
#>  8           1     4     1        1              6        1       1          3   1.35 -0.0776
#>  9           1     5     1        0              1        0       1          3   1.49  1.42  
#> 10           1     5     1        1              1        0       0          3   1.49  1.42  
#> # ℹ 2,490 more rows
...
#> ~item (Number of levels: 25) 
#>                               Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
#> sd(Intercept)                     0.10      0.08     0.00     0.29 1.00     1717     1659
#> sd(dprime_Intercept)              0.66      0.16     0.41     1.05 1.01      835     1572
#> sd(c_Intercept)                   0.75      0.12     0.56     1.01 1.00      745     1250
#> sd(metac2zero1diff_Intercept)     0.18      0.11     0.01     0.42 1.00      813     1305
#> sd(metac2zero2diff_Intercept)     0.10      0.08     0.00     0.29 1.00     1368     1605
#> sd(metac2one1diff_Intercept)      0.09      0.07     0.00     0.25 1.00     1581     2063
#> sd(metac2one2diff_Intercept)      0.07      0.06     0.00     0.22 1.00     2116     1776
#> 
#> ~participant (Number of levels: 50) 
#>                               Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
#> sd(Intercept)                     0.10      0.08     0.00     0.29 1.00     1270     1434
#> sd(dprime_Intercept)              0.36      0.08     0.20     0.53 1.00     1604     1501
#> sd(c_Intercept)                   0.36      0.05     0.28     0.46 1.00     1353     2219
#> sd(metac2zero1diff_Intercept)     0.31      0.11     0.09     0.53 1.01      679      609
#> sd(metac2zero2diff_Intercept)     0.22      0.11     0.02     0.42 1.00      872     1444
#> sd(metac2one1diff_Intercept)      0.12      0.08     0.01     0.30 1.00     1101     1711
#> sd(metac2one2diff_Intercept)      0.37      0.11     0.16     0.59 1.01     1029     1261
#> 
#> Regression Coefficients:
#>                           Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
#> Intercept                    -0.26      0.08    -0.43    -0.10 1.00     4828     3062
#> dprime_Intercept              1.14      0.16     0.79     1.43 1.00      820     1531
#> c_Intercept                   0.12      0.13    -0.15     0.37 1.01      539     1183
#> metac2zero1diff_Intercept    -0.84      0.07    -0.98    -0.69 1.00     1989     2258
#> metac2zero2diff_Intercept    -0.85      0.06    -0.96    -0.72 1.00     3067     2664
#> metac2one1diff_Intercept     -0.83      0.06    -0.94    -0.72 1.00     4559     2800
#> metac2one2diff_Intercept     -0.84      0.06    -0.96    -0.71 1.00     2983     3002
#> 
#> Draws were sampled using sampling(NUTS). For each parameter, Bulk_ESS
#> and Tail_ESS are effective sample size measures, and Rhat is the potential
#> scale reduction factor on split chains (at convergence, Rhat = 1).
...
#> 1     1              1        0          3  0.594 ± 0.058  0.90 ± 0.029
#> 2     1              2        0          2  0.417 ± 0.059  0.81 ± 0.044
#> 3     1              3        0          1  0.248 ± 0.049  0.68 ± 0.056
#> 4     1              4        1          1  0.139 ± 0.035  0.50 ± 0.061
#> 5     1              5        1          2  0.068 ± 0.021  0.32 ± 0.055
```
...
#>    .row joint_response response confidence           p_fa         p_hit
#>   <int>          <int>    <int>      <dbl>     <rvar[1d]>    <rvar[1d]>
#> 1     1              1        0          3  0.595 ± 0.058  0.89 ± 0.029
#> 2     1              2        0          2  0.418 ± 0.059  0.80 ± 0.044
#> 3     1              3        0          1  0.249 ± 0.049  0.67 ± 0.056
#> 4     1              4        1          1  0.140 ± 0.035  0.49 ± 0.060
#> 5     1              5        1          2  0.068 ± 0.021  0.32 ± 0.054
```
...
#>  1     1           1              1        0          3  0.51 ± 0.097  0.83 ± 0.065
#>  2     2           2              1        0          3  0.83 ± 0.065  0.99 ± 0.011
#>  3     3           3              1        0          3  0.32 ± 0.091  0.69 ± 0.085
#>  4     4           4              1        0          3  0.66 ± 0.091  0.93 ± 0.036
#>  5     5           5              1        0          3  0.37 ± 0.095  0.69 ± 0.087
#>  6     6           6              1        0          3  0.55 ± 0.098  0.90 ± 0.046
#>  7     7           7              1        0          3  0.66 ± 0.091  0.96 ± 0.025
#>  8     8           8              1        0          3  0.45 ± 0.099  0.76 ± 0.079
#>  9     9           9              1        0          3  0.76 ± 0.077  0.95 ± 0.027
#> 10    10          10              1        0          3  0.68 ± 0.091  0.85 ± 0.061
#> # ℹ 240 more rows
```
...
#>    <int> <int>          <int>    <int>      <dbl>    <rvar[1d]>     <rvar[1d]>
#>  1     1     1              1        0          3  0.81 ± 0.046  0.97 ± 0.0118
#>  2     2     2              1        0          3  0.36 ± 0.064  0.84 ± 0.0400
#>  3     3     3              1        0          3  0.57 ± 0.065  0.99 ± 0.0052
#>  4     4     4              1        0          3  0.62 ± 0.061  0.96 ± 0.0156
#>  5     5     5              1        0          3  0.14 ± 0.047  0.67 ± 0.0603
#>  6     6     6              1        0          3  0.29 ± 0.062  0.51 ± 0.0649
#>  7     7     7              1        0          3  0.42 ± 0.065  0.79 ± 0.0476
#>  8     8     8              1        0          3  0.45 ± 0.067  0.86 ± 0.0379
#>  9     9     9              1        0          3  0.90 ± 0.031  0.99 ± 0.0038
#> 10    10    10              1        0          3  0.38 ± 0.065  0.86 ± 0.0368
#> # ℹ 115 more rows
```
