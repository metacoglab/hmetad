...
#>        <int>    <int>    <int>   <int>      <int> <int>  <dbl> <dbl>       <dbl>
#>  1         1        0        0       1          1   932      1     0           1
#>  2         1        0        0       1          2   943      1     0           1
#>  3         1        0        0       1          3   779      1     0           1
#>  4         1        0        0       1          4   821      1     0           1
#>  5         1        0        1       0          1   774      1     0           1
#>  6         1        0        1       0          2   436      1     0           1
#>  7         1        0        1       0          3   215      1     0           1
#>  8         1        0        1       0          4   100      1     0           1
#>  9         1        1        0       0          1   707      1     0           1
#> 10         1        1        0       0          2   482      1     0           1
#> # ℹ 22 more rows
#> # ℹ 6 more variables: M <dbl>, meta_c2_0 <list>, meta_c2_1 <list>, theta <dbl>,
#> #   theta_1 <dbl>, theta_2 <dbl>
