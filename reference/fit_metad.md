...
#> Chain 2: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 2: 
#> Chain 2:  Elapsed Time: 0.826 seconds (Warm-up)
#> Chain 2:                1.861 seconds (Sampling)
#> Chain 2:                2.687 seconds (Total)
#> Chain 2: 
#> 
#> SAMPLING FOR MODEL 'anon_model' NOW (CHAIN 3).
#> Chain 3: 
...
#> Chain 3: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 3: 
#> Chain 3:  Elapsed Time: 1.697 seconds (Warm-up)
#> Chain 3:                1.875 seconds (Sampling)
#> Chain 3:                3.572 seconds (Total)
#> Chain 3: 
#> 
#> SAMPLING FOR MODEL 'anon_model' NOW (CHAIN 4).
#> Chain 4: 
...
#> Chain 4: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 4: 
#> Chain 4:  Elapsed Time: 3.401 seconds (Warm-up)
#> Chain 4:                1.789 seconds (Sampling)
#> Chain 4:                5.19 seconds (Total)
#> Chain 4: 
